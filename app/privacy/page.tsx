        ...
        <Section mx="auto" className="prose text-center">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Invaded Map.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Invaded Map, accessible from{" "}
                <a
          ...
          <ul>
            <li>
              ...
              <a
                href="mailto: hello@invaded-map.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                hello@invaded-map.com
              </a>
            </li>
          </ul>
        </Section>
