    ...
    <Container pr="4" asChild>
      <main>
        <Section mx="auto" className="prose text-center">
          ...
          <p>Welcome to Invaded Map!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Invaded Map&apos;s Website, located at {process.env.URL}.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use Invaded Map if you do not agree
          ...
          <p>
            ...
            and subject to, prevailing law of fr. Any use of the above
          ...
          <p>
            We employ the use of cookies. By accessing Invaded Map, you agreed
            to use cookies in agreement with the Invaded Map&apos;s Privacy
            Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Invaded Map and/or its licensors own the
            intellectual property rights for all material on Invaded Map. All
            intellectual property rights are reserved. You may access this from
            Invaded Map for your own personal use subjected to restrictions set
            in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Invaded Map</li>
            <li>Sell, rent or sub-license material from Invaded Map</li>
            <li>Reproduce, duplicate or copy material from Invaded Map</li>
            <li>Redistribute content from Invaded Map</li>
          </ul>
          ...
          <p>
            ...
            Invaded Map does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of Invaded Map,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, Invaded
            Map shall not be liable for the Comments or for any liability,
          ...
          <p>
            Invaded Map reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Invaded Map a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Invaded Map;
          ...
          <p>
            ...
            sending an e-mail to Invaded Map. Please include your name, your
          ...
          <p>
            No use of Invaded Map&apos;s logo or other artwork will be allowed
