  ...
  return (
    <div className="prose-sm mt-32 pb-16 text-center lg:prose">
      ...
      <p>
        ...
        of Invaded Map&apos;s Website, located at {process.env.URL}.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Invaded Map if you do not agree to
      ...
      <p>
        ...
        prevailing law of fr. Any use of the above terminology or other words in
      ...
      <p>
        We employ the use of cookies. By accessing Invaded Map, you agreed to
        use cookies in agreement with the Invaded Map&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        ...
        Invaded Map for your own personal use subjected to restrictions set in
      ...
      <p>
        ...
        Invaded Map does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Invaded Map,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, Invaded Map shall not be
      ...
      <p>
        Invaded Map reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Invaded Map a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Invaded Map; and (d) the link
      ...
      <p>
        ...
        e-mail to Invaded Map. Please include your name, your organization name,
      ...
      <p>
        No use of Invaded Map&apos;s logo or other artwork will be allowed for
